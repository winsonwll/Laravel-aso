    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#">{{ Session::get('admin')->name }}</a></li>
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                <li @if (Request::is('task')) class="active" @endif><a href="{{ URL('/task') }}">任务列表</a></li>
                <li @if (Request::is('task/create')) class="active" @endif><a href="{{ URL('/task/create') }}">创建任务</a></li>
                <li @if (Request::is('task/record')) class="active" @endif><a href="{{ URL('/task/record') }}">完成情况</a></li>
            </ul>
            <h3>账号管理</h3>
            <ul class="nav nav-sidebar">
